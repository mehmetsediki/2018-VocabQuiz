...
<div class="logo">
	<a href="index.html">
	<img src="<?php echo base_url();?>assets/logo.png" style="width: 150px;"  alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
<form class="login-form" action="<?php echo base_url();?>LoginController/login_check" method="post">
